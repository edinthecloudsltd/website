    ...
    <Layout>
      ...
      <MaxWidthWrapper>
        <section className="pt-32">
          <h1 className="font-sans text-4xl font-black text-center text-gray-700 dark:text-red-300 lg:text-6xl">
            Ed in the Clouds
          </h1>
        </section>
          ...
          <div className="my-6">
            ...
            <div className="object-cover bg-gray-200 dark:bg-gray-500">
              <div className="flex flex-row flex-wrap justify-center p-4">
                {platform.map((img, id) => (
                  <img key={id} src={img.src} alt={img.alt} className="flex-shrink w-16 h-16 m-2" />
                ))}
              </div>
            </div>
          </div>
